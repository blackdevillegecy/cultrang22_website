...
export default function Dramatics() {
    return (
        <div className="Event-Dramatics" >
            ...
            <Item link="https://res.cloudinary.com/dwjesc65k/image/upload/v1676053873/cultrang%2723/Poster_tamasha_ztqrkd.png" registration="https://forms.gle/ocBzacJrPcQGracJ8" rulebook="https://drive.google.com/file/d/1-kr3_jsS5p0zWUnVx8R1mr0NkGLGVkn4/view"></Item>

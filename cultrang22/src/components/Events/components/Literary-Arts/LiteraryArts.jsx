...
export default function LiteraryArts() {
    return (
        <div className="Event-LiteraryArts" >
            ...
            <Item link="https://res.cloudinary.com/dwjesc65k/image/upload/v1676287365/Poster-Meme_Quiz_ft3veg.png" registration="https://forms.gle/HUWJq1WXhD3aQCCV7" rulebook="https://drive.google.com/file/d/10KBBF2-GAVokz8TwpGi_MEPjZyFE_IOJ/view"></Item>
